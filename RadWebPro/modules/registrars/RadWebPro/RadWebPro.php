...
use ModulesGarden\DomainsReseller\Core\ModuleConstants;
...
if (file_exists(__DIR__ . DIRECTORY_SEPARATOR . 'registrar.custom.php'))
{
    include_once __DIR__ . DIRECTORY_SEPARATOR . 'registrar.custom.php';
}
